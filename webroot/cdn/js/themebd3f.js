...
Line 1370:26 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 1370:73 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 1379:66 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 1382:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 1383:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 1384:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 1397:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 1411:14 Transforming const to the configured target environment ("es5") is not supported yet
Line 1412:37 Transforming array spread to the configured target environment ("es5") is not supported yet
Line 1425:8 Transforming const to the configured target environment ("es5") is not supported yet
